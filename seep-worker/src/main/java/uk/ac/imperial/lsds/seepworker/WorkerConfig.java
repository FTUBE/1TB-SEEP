...
public class WorkerConfig extends Config {
	...
	static{
		config = new ConfigDef().define(DEPLOYMENT_TARGET_TYPE, Type.INT, 0, Importance.HIGH, DEPLOYMENT_TARGET_TYPE_DOC)
				...
				.define(NUM_NETWORK_READER_THREADS, Type.INT, 1, Importance.MEDIUM, NUM_NETWORK_READER_THREADS_DOC)
				...
				.define(BATCH_SIZE, Type.INT, 50240/*100*/, Importance.HIGH, BATCH_SIZE_DOC)
