...
public class WorkerConfig extends Config {
	...
	static{
		config = new ConfigDef().define(DEPLOYMENT_TARGET_TYPE, Type.INT, 0, Importance.HIGH, DEPLOYMENT_TARGET_TYPE_DOC)
				...
				.define(NUM_NETWORK_WRITER_THREADS, Type.INT, 1, Importance.MEDIUM, NUM_NETWORK_WRITER_THREADS_DOC)
				...
				.define(SIMPLE_INPUT_QUEUE_LENGTH, Type.INT, 5000, Importance.MEDIUM, SIMPLE_INPUT_QUEUE_LENGTH_DOC)
				.define(BATCH_SIZE, Type.INT, 16000, Importance.HIGH, BATCH_SIZE_DOC)
				.define(APP_BATCH_SIZE, Type.INT, 20, Importance.HIGH, APP_BATCH_SIZE_DOC)
